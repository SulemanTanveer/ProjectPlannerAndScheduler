...
if(isset($_POST["proj_id"]))
{
 ...
 $query = "SELECT * FROM cocomo_metric WHERE cID= '".$_POST["proj_id"]."'";
...
<?php
	...
	<tr><th width="40%">						
	 <label> Metric ID  </label></th><td><?php echo $row["cID"]?></td>
</tr>
<tr>	<th width="40%"> 
	 <label> Metric Type  </label></th><td>Cocomo Model</td>	
	 </tr>
	 <tr>	 <th width="40%">
	 <label> Project Type  </label>	</th><td><?php echo $row["pType"]?></td>
	 </tr>
	 <tr><th width="40%">
