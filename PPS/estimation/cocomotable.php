    ...
    <thead>
		...
		$result = mysqli_query($connect, $query);
                  ...
                  <tr>   
                   ...
                   <td><button type="button" name="view" value="view" id="<?php echo $row["cID"]; ?>" class="btn btn-warning btn-xs view_Cdata" ><i class="fa fa-search-plus"></i> View</button>
                     
                    <button type="button" name="delete" value="delete" id="<?php echo $row["cID"]; ?>" class="btn btn-danger btn-xs delete_cocomodata" ><i class="fa fa-trash-o"></i> Delete</button></td>
...
<script>
   $(document).on('click', '.view_Cdata', function(){
     //$('#dataModal').modal();
