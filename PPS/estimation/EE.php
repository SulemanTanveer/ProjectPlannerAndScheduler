...
?>	
					...
					<label>Enter person per month rate</label>
						<input type="number" id="rate"	min="0" class="form-control">
					</div>
...
<div id="add_data_Modal" class="modal fade">
   <div class="modal-dialog modal-lg">
    ...
    <tbody>
	<tr> <td>Type</td> <td>Function Point</td></tr>
...
<script src="js/EmpiricalScript.js"></script>
...
<input type="hidden"  id="pd" value="" class="form-control">
<input type="hidden"  id="dd" value="" class="form-control">
<input type="hidden"  id="ct" value="" class="form-control">
<input type="hidden"  id="i" value="" class="form-control">
<input type="hidden"  id="m" value="" class="form-control">
