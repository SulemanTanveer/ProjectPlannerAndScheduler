    ...
    <thead>
		...
		$result = mysqli_query($connect, $query);
                  ...
                  <tr>   
                   ...
                   <td><button type="button" name="view" value="view" id="<?php echo $row["ucpID"]; ?>" class="btn btn-warning btn-xs view_Udata" ><i class="fa fa-search-plus"></i> View</button>
                    
                    <button type="button" name="delete" value="delete" id="<?php echo $row["ucpID"]; ?>" class="btn btn-danger btn-xs delete_ucdata" ><i class="fa fa-trash-o"></i> Delete</button></td>
...
<script>
   $(document).on('click', '.view_Udata', function(){
     //$('#dataModal').modal();
     var fpid = $(this).attr("id");
   $.ajax({
      url:"viewUcpMetric.php",
      method:"POST",
      data:{proj_id:fpid},
