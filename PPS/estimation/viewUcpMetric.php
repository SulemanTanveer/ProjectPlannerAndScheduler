...
if(isset($_POST["proj_id"]))
{
 ...
 $query = "SELECT * FROM ucp_metric WHERE ucpID= '".$_POST["proj_id"]."'";
...
<?php
	...
	<tr><th width="40%">						
	 <label> Metric ID  </label></th><td><?php echo $row["ucpID"]?></td>
</tr>
<tr>	<th width="40%"> 
	 <label> Metric Type  </label></th><td>Use Case Point</td>	
	 </tr>
	 <tr>	 <th width="40%">
	 <label> Use Case Points  </label>	</th><td><?php echo $row["ucp"]?></td>
	 </tr>
	 <tr><th width="40%">
...
<tr>	<th width="40%"> 	 <label> Reg Date </label>	</th><td><?php echo $row2["regDate"]?></td></tr>
  ...
  <div class="row">
                    <div class="col-lg-12">
						    ...
						    <div class="panel panel-green" >
                            <div class="panel-heading">
                                <h3 class="panel-title"></i>Use Case Point Estimated Metrics</h3>
                            </div>
                            <div class="panel-body">
