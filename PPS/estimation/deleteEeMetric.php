<?php
include("config.php"); 
$query2 = "SELECT mID FROM ee_metric WHERE eeID = '".$_POST["Metric_id"]."'"; 
$metricID = mysqli_query($connect, $query2); 

$row = mysqli_fetch_array($metricID);


	$query = "DELETE FROM ee_metric WHERE eeID = '".$_POST["Metric_id"]."'";  
	...
	echo '<center><div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-success alert-dismissable">
                            ...
                            <i class="fa fa-check"></i>  <strong>Empirical Model metric deleted </strong>
							</div>
                    </div>
                </div><center>';
}
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title"></i>Emperical model Estimated Metrics</h3>
                            </div>
    ...
    <thead>
		...
		$result = mysqli_query($connect, $query);
                  ...
                  <tr>   
                   ...
                   <td><input type="button" name="view" value="view" id="<?php echo $row["eeID"]; ?>" class="btn btn-warning btn-xs view_data" />
                     
                     <input type="button" name="delete" value="delete" id="<?php echo $row["eeID"]; ?>" class="btn btn-danger btn-xs delete_eedata" /></td>
