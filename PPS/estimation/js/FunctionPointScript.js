 //validate data before calculating function point//
...
for(var i = 0; i < id.length; i++){
	...
	document.getElementById("f").value=document.getElementById("myTable2").rows[1].cells[1].innerHTML;
	...
	$('#addMetric').click(function(){  
     ...
     var _fp = $('#functionPoint').val();
	 var  _effort= $('#fpEffort').val();
	 var _size = $('#fpSize').val();
	 var _cost = $('#fpCost').val();
	 var _duration = $('#fpDuration').val();
