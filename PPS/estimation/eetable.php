    ...
    <thead>
		...
		$result = mysqli_query($connect, $query);
                  ...
                  <tr>   
                   ...
                   <td><button type="button" name="view" value="view" id="<?php echo $row["eeID"]; ?>" class="btn btn-warning btn-xs view_Edata" > <i class="fa fa-search-plus"></i> View</button>
                     
                    <button type="button" name="delete" value="delete" id="<?php echo $row["eeID"]; ?>" class="btn btn-danger btn-xs delete_eedata" ><i class="fa fa-trash-o"></i> Delete</button></td>
...
<script>
   $(document).on('click', '.view_Edata', function(){
     //$('#dataModal').modal();
