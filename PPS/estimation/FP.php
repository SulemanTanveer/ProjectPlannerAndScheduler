                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
							...
							<li class ="active">  Function Point </li>
                        </ol>
                    </div>
...
include("config.php");
			...
			while($row = mysqli_fetch_array($result)){
				...
				{
				echo"	<option value= ". $row['languageId']." title='no previous record found for estimation' disabled >   ".$row['languageName']." </option>";
				}
			}			
?>	
					...
					<label>Enter person per month rate</label>
						<input type="number" id="rate"	min="0" class="form-control empRate">
					</div>
...
<!-- function point calculation end here-->
         <!-- /.row -->       
					...
					<script src="js/FunctionPointScript.js"></script>
...
<div id="add_data_Modal" class="modal fade">
   <div class="modal-dialog modal-lg">
	...
	<tr> <td>Function Points</td> <td id="fps" name="fps" ></td></tr>
...
<input type="hidden"  id="f" value="" class="form-control">
