...
if(isset($_POST["proj_id"]))
{
 ...
 $query = "SELECT * FROM ee_metric WHERE eeID= '".$_POST["proj_id"]."'";
...
<?php
	...
	<tr><th width="40%">						
	 <label> Metric ID  </label></th><td><?php echo $row["eeID"]?></td>
</tr>
<tr>	<th width="40%"> 
	 <label> Metric Type  </label></th><td>Empirical Model</td>	
	 </tr>
	 <tr>	 <th width="40%">
	 <label> Model Type  </label>	</th><td><?php echo $row["model"]?></td>
	 </tr>
	 <tr><th width="40%">
...
<tr>	<th width="40%"> 	 <label> Reg Date </label>	</th><td><?php echo $row2["regDate"]?></td></tr>
  ...
  <div class="row">
                    <div class="col-lg-12 ">
						    ...
						    <div class="panel panel-yellow" >
                            <div class="panel-heading">
                                <h3 class="panel-title"></i>Empirical Model Estimated Metrics</h3>
                            </div>
                            <div class="panel-body">
	 ...
	 ?>
	   ...
	   <div class="row">
                    <div class="col-lg-12 ">
						    ...
						    <div class="panel panel-yellow" >
                            <div class="panel-heading">
                                <h3 class="panel-title">Schedule Distribution</h3>
                            </div>
                            <div class="panel-body">
   <table  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
	 <tr>  <th> Product Design <br>(person months)</th><th> Detailed Design<br> (person months)</th><th> Code & Test <br>(person months)</th><th>Integration & Test <br>(person months)</th> </tr>
	 <tr>  <td> <?php echo $row["pDesign"]?></td><td><?php echo $row["dDesign"]?></td><td> <?php echo $row["codeTest"]?></td><td><?php echo $row["intTest"]?></td> </td>
	 </table>
