                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
									...
									<div id="tttt">
									<div class="huge" id='total1'><?php echo  $count1 ; ?></div>
                            ...
                            <a href="#" id='total2'onclick="return false;">
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
									<div  id="ttt" >
									<div class="huge" id='seen1'><?php echo  $count2; ?></div>
                                        </div>
                                        <div>Seen</div>
                                    </div>
                                </div>
                            </div>
                            <a href="#" id='seen2'onclick="return false;">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                        ...
                        <div class="panel panel-red" >
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                      <div class="huge" id='unseen1'><?php echo  $count3 ; ?></div>
                            ...
                            <a href="#"id='unseen2' onclick="return false;">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
    ...
    <thead>
		...
		$result = mysqli_query($connect, $query);
              ...
              <td ><center><?php 
					 if($row["open"]=='1')
					 {
					 echo '<p class="'.$row["id"].'" style="background-color: #00D211; color:white">Seen</p>'; 
					 }
					 else  {
						 echo '<p  class="'.$row["id"].'" style="background-color: #FE0000; color:white">Unseen</p>'; 
					 }
					  
					 ?> </center></td>
					  <td><a onclick="return false;"  href="#" id="<?php echo $val2; ?>" class="check3" ><?php echo $filename;?></a></td>
                      <td>
					  
					  <button type="button" name="view" value="view" id="<?php echo $row["id"]; ?>" class="btn btn-warning btn-xs view_data" /><i  class="fa fa-search-plus"></i> View</button> 
                      <button type="button" name="reply" value="reply" id="<?php echo $row["id"]; ?>" class="btn btn-info btn-xs reply_data" /><i class="fa fa-reply"></i> Reply</button> 
 ...
 $result = mysqli_query($connect, $sql);
   ...
   <div class="row">
        ...
        <div class="row">
			...
			<div class="row">
            <div class="col-md-12">
			<input type="hidden" name="outcheck" class="btn btn-success btn-send" value="in">
...
<div id="add_data_Modal2" class="modal fade">
   <div class="modal-dialog ">
      <div class="modal-content">
           ...
           <div class="modal-header" style=" background-color: #4fc3f7   ;color:white;">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
           <center> <h4 class="modal-title"><span class="fa fa-reply"></span>&nbsp&nbspReply Message</h4> </center>
         </div>
         <div class="modal-body">
           
		  <form id="message_form2" method="post"  role="form">
       ...
       <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input  type="text" name="receiver" id="receiver2"class="form-control" readonly>
                    <div class="help-block with-errors"></div>
                </div>
            </div>
   ...
   <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="form_email">Subject</label>
                    <input  type="text" name="subject" id="subject2"class="form-control" placeholder="Please Enter Subject" >
                    <div class="help-block with-errors"></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="form_message">Message</label>
                    <textarea  name="message" id="message2" class="form-control" placeholder="Please Enter Message" rows="4" required="required" data-error="Please,leave us a message."></textarea>
                    <div class="help-block with-errors"></div>
                </div>
            </div>
			  <div class="col-md-12">
               <label class="btn btn-default btn-file">
					Attach File <i class="fa fa-paperclip"></i>
					<input type="file" name="filename[]" id="select_image2" style="display: none;" >
				</label>
            </div></div>    
			<div class="row">
            <div class="col-md-12">
               <br><input type="submit" id="go2" class="btn btn-info btn-send" value="Send">
            </div>
        </div>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <button type="button" id="close" class="btn btn-default" data-dismiss="modal">Close</button></div>
      </div>
   </div>
</div>
