  ...
  $count1=0;
										...
										$result3 = mysqli_query($connect, $query3);
										   ...
										   while($row1 = mysqli_fetch_array($result1))
											 ...
											 $query3 = "SELECT * FROM project   where teamId ='".$row1['teamId']."' AND projStatus='Completed'";
										$result3 = mysqli_query($connect, $query3);
										...
										$result1 = mysqli_query($connect, $query1);
										   while($row1 = mysqli_fetch_array($result1))
													...
													$query3 = "SELECT * FROM project   where teamId ='".$row1['teamId']."' AND projStatus='In-Progress'";
										$result3 = mysqli_query($connect, $query3);
										...
										$result1 = mysqli_query($connect, $query1);
										   while($row1 = mysqli_fetch_array($result1))
													...
													$query3 = "SELECT * FROM project   where teamId ='".$row1['teamId']."' AND projStatus='Not Started'";
										$result3 = mysqli_query($connect, $query3);
                    ...
                    <div class="col-lg-3 col-md-6">
                     ...
                     <div class="col-lg-3 col-md-6">
                        <div class="panel panel-red">
                            ...
                            <a href="#" id='ns_proj' onclick='return false'>
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
...
echo" <option value='" . $val."'>".$val."</option>";
    ...
    while ($row = mysqli_fetch_array($result)) {
     ...
     echo "</select><br>";
			 ...
			 <select id="opt2" name="projStatus" class='form-control' >
