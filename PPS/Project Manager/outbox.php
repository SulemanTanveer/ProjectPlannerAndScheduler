		...
		$result = mysqli_query($connect, $query);
                   ...
                   <tr>   
                     ...
                     <td><?php echo $subject ?></td>
					  ...
					  <a href="#" id="<?php echo $val2; ?>" class="check3"><?php echo $filename;?></a>
					  
					  </td>
                      <td> <center><button type="button" name="view" value="view" id="<?php echo $row["id"]; ?>" class="btn btn-warning btn-xs view_data" /><i  class="fa fa-search-plus"></i> View</button> 
