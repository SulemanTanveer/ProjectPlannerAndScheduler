...
$flag=false;
 ...
 $count3=0;
 $count4=0;
 $query55 = "SELECT * FROM subtask WHERE taskId='".$_POST["proj_id"]."'";
 $result55 = mysqli_query($connect, $query55);		
$count55 = mysqli_num_rows($result55);
if($count55>0){
$flag=true;
$query = "SELECT * FROM subtask WHERE taskId='".$_POST["proj_id"]."' AND subtaskStatus ='Pending'"; 
$result = mysqli_query($connect, $query);		
$count1 = mysqli_num_rows($result);
$query = "SELECT * FROM subtask WHERE taskId='".$_POST["proj_id"]."' AND subtaskStatus ='Not Started'"; 
$result = mysqli_query($connect, $query);		
$count2 = mysqli_num_rows($result);
$query = "SELECT * FROM subtask WHERE taskId='".$_POST["proj_id"]."' AND subtaskStatus ='In-Progress'"; 
$result = mysqli_query($connect, $query);		
$count3 = mysqli_num_rows($result);
$query = "SELECT * FROM subtask WHERE taskId='".$_POST["proj_id"]."' AND subtaskStatus ='Completed'"; 
$result = mysqli_query($connect, $query);		
