        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<?php
											   ...
											   $query = "SELECT * FROM employee WHERE workStatus='Active'";
											   $result = mysqli_query($connect, $query);
														
										       $count2 = mysqli_num_rows($result);
										       
											   $query = "SELECT * FROM employee WHERE workStatus='In-Active'";
											   $result = mysqli_query($connect, $query);
														
										       $count3 = mysqli_num_rows($result);
												$query = "SELECT * FROM employee WHERE workStatus='On Leave'";
											   $result = mysqli_query($connect, $query);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                       <div class="huge"><?php echo $count4?> </div>
                                        <div>On Leave Employees</div>
                                    </div>
                                </div>
                            </div>
                           <a href="#" id='on_leave' onclick="return false;">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
		  ...
		  include("config.php");
		   ...
		   $result = mysqli_query($connect, $query);
                  ...
                  <tr>   
                      ...
                      <td><center><?php echo $row["empName"]; ?></center></td>
				...
				echo '<li>'.$row21['languageName'].'</li>';
					 ...
					 ?> </center></td>
                      <td><center>
					  <button   name="view" value="view" id="<?php echo $row["empId"]; ?>" class="btn btn-warning btn-xs view_data" /><i  class="fa fa-search-plus"></i> View</button>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
										       ...
										       <div id='employee_detail3'class="huge"> </div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
										       ...
										       <div  class="huge" id='employee_detail0'></div>
						...
						<div class="panel panel-red" >
                            <div class="panel-heading">
                                <div class="row">
                                  ...
                                  <div  class="huge" id='employee_detail4'></div>
