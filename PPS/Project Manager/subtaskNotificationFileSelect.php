...
$query = "SELECT * FROM subtaskfiles  WHERE subtaskId= '".$subtaskId."'  ";
	$query44 = "UPDATE notification SET seen='1' WHERE notificationId= '".$notiId."'";  
		...
		if(mysqli_num_rows($result)>0){			   
					   ...
					   $query = "SELECT * FROM subtaskfiles  WHERE subtaskId= '".$subtaskId."' ORDER BY subtaskFileId DESC";
...
';
					 ...
					 while($row2 = mysqli_fetch_array($result2))
    {
     ...
     $output .= '
	     <tr>  
             <td ><a href="#"  id="'.$val2.'" class="check3">'. $row["fileName"] .'</a></td>  
