...
$query44 = "UPDATE notification SET seen='1' WHERE notificationId= '".$notiId."'";  
   ...
   $query = "SELECT * FROM taskfiles  WHERE taskId= '".$taskId."'   ";
...
if(mysqli_num_rows($result)>0){
					   ...
					   $query = "SELECT * FROM taskfiles  WHERE taskId= '".$taskId."' ORDER BY taskFileId DESC ";
...
';
					 ...
					 while($row2 = mysqli_fetch_array($result2))
    {
     ...
     $output .= '
	     <tr>  
             <td ><a href="#"  id="'.$val2.'" class="check2">'. $row["fileName"] .'</a></td>  
