...
list($taskId, $notiId) = explode("-", $data);
...
$flag=false;
 ...
 $count3=0;
 $count4=0;
 $query55 = "SELECT * FROM subtask WHERE taskId='".$taskId ."'";
 $result55 = mysqli_query($connect, $query55);		
$count55 = mysqli_num_rows($result55);
if($count55>0){
$flag=true;
$query = "SELECT * FROM subtask WHERE taskId='".$taskId ."' AND subtaskStatus ='Pending'"; 
$result = mysqli_query($connect, $query);		
$count1 = mysqli_num_rows($result);
$query = "SELECT * FROM subtask WHERE taskId='".$taskId ."' AND subtaskStatus ='Not Started'"; 
$result = mysqli_query($connect, $query);		
$count2 = mysqli_num_rows($result);
$query = "SELECT * FROM subtask WHERE taskId='".$taskId ."' AND subtaskStatus ='In-Progress'"; 
$result = mysqli_query($connect, $query);		
$count3 = mysqli_num_rows($result);
$query = "SELECT * FROM subtask WHERE taskId='".$taskId ."' AND subtaskStatus ='Completed'"; 
$result = mysqli_query($connect, $query);		
$count4 = mysqli_num_rows($result);
 ...
 $query = "SELECT * FROM task WHERE taskId= '".$taskId ."'";
 $result = mysqli_query($connect, $query);
  $query2 = "UPDATE task SET deadlineFlag='1' WHERE taskId= '".$taskId ."'";
...
$total_count=0;
 ...
 $progress=0;
 $check=0;
$query888 = "SELECT * FROM task WHERE  taskId= '".$taskId ."'";
 ...
 if($row888['taskStatus']=='Completed'){
	...
	$query8 = "SELECT * FROM subtask WHERE  taskId= '".$taskId ."'";
...
////////////////////
	 ...
	 <tr >  
            ...
            <td >'.$row["taskId"].'</td>  
			<td valign="top" rowspan="9" style="background-color:white">
...
<div id="piechart_3d"  ></div>
	...
	$sql3="SELECT * FROM taskassignment WHERE taskId= '".$taskId ."'";
