    ...
    <thead>
		...
		$result = mysqli_query($connect, $query);
                   ...
                   $query2 = "SELECT * FROM `employee` WHERE empId='".$row["senderId"]."'";  
					...
					echo'   <button type="button" name="view" value="view"  id="'.$Id.'" class="btn btn-warning btn-xs accnt_noti" ><i  class="fa fa-search-plus"></i> View</button> ';
					...
					echo'   <button type="button" name="view" value="view"  id="'.$Id.'" class="btn btn-warning btn-xs task_Noti" ><i  class="fa fa-search-plus"></i> View</button> ';
					...
					echo'   <button type="button" name="view" value="view"  id="'.$Id.'" class="btn btn-warning btn-xs subtask_Noti" ><i  class="fa fa-search-plus"></i> View</button> ';
